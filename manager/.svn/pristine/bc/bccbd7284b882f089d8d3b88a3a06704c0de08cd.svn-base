    ...
    <div class="productbackgroud">
        ...
        >
            ...
            <el-form :model="formData" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                <el-form-item label="背景图片" prop="backgroundpicurl" class="partnerbackgroudurl">
                    <el-upload
                ...
                <el-form-item label="标题图片" prop="titlepicurl" class="partnertitlepicurl">
                    <el-upload
                        class="avatar-uploader"
                        :action="uploaduri"
...
<script>
    import {getBackgroudPic,backgroudPicEdit} from "../../api/cooperativePartner/cooperativePartner";
            ...
            formSumbit() {
                ...
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        ...
                        this.formData.backgroundtype=3;
...
<style type="text/scss" lang="scss">
    ...
    /*}*/
    .partnerbackgroudurl .el-upload{
        width: 341.5px;
        height:  177.25px;
    }
    .partnerbackgroudurl img{
        width: 341.5px;
        height:  177.25px;
    }
    .partnertitlepicurl .el-upload{
        width: 346px;
        height: 67px;
    }
    .partnertitlepicurl img{
        width: 346px;
        height: 67px;
    }
</style>
