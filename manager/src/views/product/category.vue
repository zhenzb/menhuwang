<template>
    <div style="width: 95%; margin-left: 2%;">
        ...
        >
            ...
            <el-table-column label="编号" prop="categoryId" width="50" align="center"/>
            <el-table-column label="标签名称" prop="categoryName" align="left" :show-overflow-tooltip="true"/>
            <el-table-column label="标签类型" with="200" :show-overflow-tooltip="true" align="center">
                <template slot-scope="scope">
                    <span v-if="scope.row.categoryType ==1">案例</span>
                    <span v-if="scope.row.categoryType ==2">新闻</span>
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作" align="center" width="210">
                <template slot-scope="scope">
                    <el-button type="danger" size="mini" @click.native="handleDel(scope.row.categoryId)" >删除 </el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--列表end --222e-->
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="rules" ref="ruleForm" label-width="85px" class="demo-ruleForm">
                <el-form-item label="标签类型:" prop="categoryType">
                    <el-select v-model="formData.categoryType" placeholder="请选择" style="width: 330px">
                          <el-option label="案例" :value="1"></el-option>
                          <el-option label="新闻" :value="2"></el-option>
                      </el-select>
                </el-form-item>
                <el-form-item label="标签名称:" prop="categoryName" >
                    <el-input v-model="formData.categoryName" style="width: 60%"></el-input>
                </el-form-item>
            </el-form>
