<template>
    <div style="width: 95%; margin-left: 2%;">
        ...
        >
            ...
            <el-table-column label="编号" prop="friendshiplinkId" width="50" align="center"/>
            <el-table-column label="名称" prop="friendshiplinkName" align="left" :show-overflow-tooltip="true"/>
            <el-table-column label="链接" prop="friendshiplinkUrl" align="left" :show-overflow-tooltip="true"/>
            ...
            <el-table-column label="操作" align="center" width="210">
                <template slot-scope="scope">
                  <el-button type="primary" size="mini"  @click.native="showDialogAddOrEdit(scope.$index, scope.row)" >编辑 </el-button>
                    <el-button type="danger" size="mini" @click.native="handleDel(scope.row.friendshiplinkId)" >删除 </el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--列表end --222e-->
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="rules" ref="ruleForm" label-width="85px" class="demo-ruleForm">
                <el-form-item label="名称:" prop="friendshiplinkName" >
                    <el-input v-model="formData.friendshiplinkName" style="width: 60%"></el-input>
                </el-form-item>
                <el-form-item label="链接:" prop="friendshiplinkUrl" >
                    <el-input v-model="formData.friendshiplinkUrl" style="width: 60%"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer ">
                <el-button @click="hideDialogAddOrEdit">取 消</el-button>
                <el-button type="primary" :loading="formSumbitLoding" @click.native="formSubmit()">提交</el-button>
            </span>
        </el-dialog>
        <!--新增/编辑弹框end--333e-->
    </div>
...
import {
    getFriendshipLink,
    addFriendshipLink,
    deleteFriendshipLink
} from "../../api/product/friendshipLink";
    ...
    methods: {
        ...
        delGroup() {
            ...
            var ids = this.multipleSelection
                .map(item => item.friendshiplinkId)
