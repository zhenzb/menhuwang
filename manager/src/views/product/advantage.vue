    ...
    <div style="width: 95%; margin-left: 2%;">
        ...
        <el-form :inline="true" :model="query" class="query-form" size="small">
            ...
            <el-form-item>
                ...
                <el-button type="primary" icon="el-icon-edit" @click.native="staticState(null,null)">一键静态化页面</el-button>
        ...
        >
            ...
            <el-table-column label="编号" prop="productid" width="50" align="center"/>
            <el-table-column label="案例标题" prop="producttitle" align="left" :show-overflow-tooltip="true"/>
            <el-table-column label="案例标签" prop="categoryName" align="left" :show-overflow-tooltip="true"/>
        ...
        <el-dialog
            ...
            <el-form label-width="85px">
                ...
                <el-form-item label="案例标签:">
                    <el-input v-model="formData.categoryName" style="width: 98%" readonly="readonly"></el-input>
                </el-form-item>
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="rules" ref="ruleForm" label-width="85px" class="demo-ruleForm">
                <el-form-item label="案例名称:" prop="producttitle" >
                ...
                <el-form-item label="案例标签:" prop="categoryId">
                ...
                <el-form-item label="案例图片" prop="productpic" class="productpic">
                    <el-upload
        ...
        formSumbit() {
            ...
            this.$refs["ruleForm"].validate(valid => {
                if (valid) {
                    ...
                    advantageAddOrEdit(this.formData)
                        .then(response => {
                            if (response.code) {
                                this.$message.error(response.message);
