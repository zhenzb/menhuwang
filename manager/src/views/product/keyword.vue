<template>
    <div style="width: 95%; margin-left: 2%;">
        ...
        >
            ...
            <el-table-column label="编号" prop="keywordId" width="50" align="center"/>
            <el-table-column label="关键字" prop="keywordName" align="left" :show-overflow-tooltip="true"/>
            ...
            <el-table-column label="操作" align="center" width="210">
                <template slot-scope="scope">
                    <el-button type="danger" size="mini" @click.native="handleDel(scope.row.keywordId)" >删除 </el-button>
                </template>
            </el-table-column>
        </el-table>
        <!--列表end --222e-->
        ...
        <el-dialog
            ...
            <el-form :model="formData" :rules="rules" ref="ruleForm" label-width="85px" class="demo-ruleForm">
                <el-form-item label="关键字:" prop="keywordName" >
                    <el-input v-model="formData.keywordName" style="width: 60%"></el-input>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        sortGroup() {
            console.log(this.multipleSelection);
            var ids = this.multipleSelection.map(item => item.keywordId).join(); //获取所有选中行的id组成的字符串，以逗号分隔
            if (ids == "") {
                this.$message({
                    message: "请先选择",
                    type: "warning"
