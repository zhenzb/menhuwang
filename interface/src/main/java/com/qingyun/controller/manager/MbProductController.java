...
public class MbProductController {
    ...
    public ResultVo getProductList(String text,EntyPage page) {
        try {
            List<MbProductVo> mbProducts= mbProductService.getProductList(null,text,page);
            PageSimpleVO<MbProductVo> sysProblemPageSimpleVO = new PageSimpleVO<MbProductVo>(page.getTotalNumber(), mbProducts);
